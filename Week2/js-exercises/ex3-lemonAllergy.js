...
function takeOutLemons(basket) {
    ...
    const filteredFruits = basket.filter((fruit) => fruit !== 'Lemon');
    const fruitsString = filteredFruits.join(', ')
    return 'My mom bought me a fruit basket, containing ' + fruitsString + '!';
}
